...
namespace PeclPolyfill\Inotify;

use PeclPolyfill\Functions\Inotify\Event;
use PeclPolyfill\Functions\Inotify\Exception;
use PeclPolyfill\Functions\Inotify\StreamWrapper;
...
function init(): \FFI
{
    if (!extension_loaded('ffi')) {
        throw new Exception('FFI extension not enabled');
    }
    static $ffi;
    ...
    $ffi = \FFI::load(__DIR__ . '/lib/Functions/Inotify/inotify.h');
