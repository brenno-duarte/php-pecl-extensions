...
namespace PeclPolyfill\Functions\Uopz;
...
class Uopz
{
     ...
     * @param string|array $function Function name
     */
    public static function uopzBackup($function)
    {
        self::uopzInvoke('backup', $function);
    }
     ...
     * @param bool $backup
     */
    public static function uopzFunction($function, \Closure $closure, $backup = false)
    {
        if ($backup) {
            self::uopzBackup($function);
        }
        
        self::uopzInvoke('function', $function, [$closure]);
    }
     ...
     * @param array $params
     */
    private static function uopzInvoke($name, $functionName, array $params = [])
    {
