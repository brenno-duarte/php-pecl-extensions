...
use PeclPolyfill\Functions\VarRepresentation\Node\ArrayEntry;
use PeclPolyfill\Functions\VarRepresentation\Node\ArrayLiteral;
use PeclPolyfill\Functions\VarRepresentation\Node\Group;
use PeclPolyfill\Functions\VarRepresentation\Node\ObjectConstruction;
...
class Encoder
{
     ...
     * Encode an array
     */
    protected function encodeArray(): ArrayLiteral
    {
        $entries = [];
        while (true) {
            $token = $this->peekToken();
     ...
     */
    protected function encodeObject(string $prefix): ObjectConstruction
    {
        $token = $this->getToken();
        ...
        return new ObjectConstruction($prefix, $array, ')');
    }
}